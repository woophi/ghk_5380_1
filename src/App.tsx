...
const SDUI_LINK =
  'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/55889%3flocation=AM%26campaignCode=gh5380_var1';
...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '5380_add_var1');
    setLoading(true);
      ...
      <div className={appSt.container} style={{ backgroundColor: '#F2F3F5' }}>
        ...
        <div className={appSt.rows}>
          <SelectMobile
            ...
            labelView="outer"
            onChange={({ selected }) => {
              window.gtag('event', '5380_calc1_var1');
          ...
          <SelectMobile
            ...
            labelView="outer"
            onChange={({ selected }) => {
              window.gtag('event', '5380_calc2_var1');
          ...
          <SelectMobile
            ...
            labelView="outer"
            onChange={({ selected }) => {
              window.gtag('event', '5380_calc3_var1');
          ...
          <SelectMobile
            ...
            labelView="outer"
            onChange={({ selected }) => {
              window.gtag('event', '5380_calc4_var1');
          ...
          <div className={appSt.boxWhite}>
            ...
            <ButtonMobile
              ...
              size={40}
              onClick={() => {
                window.gtag('event', '5380_sr_var1');
                setOpenBs(true);
              }}
            >
      ...
      <div className={appSt.container}>
        ...
        {faqs.map((faq, index) => (
          <div style={{ marginTop: '1rem' }} key={index}>
            <div
              onClick={() => {
                window.gtag('event', `5380_FAQ${index + 1}_var1`);
        ...
        <PureCell
          style={{ margin: '1rem 0' }}
          onClick={() => {
            window.gtag('event', '5380_moreinfo_var1');
            setOpenMInfo(true);
          }}
        >
          <PureCell.Graphics verticalAlign="center">
